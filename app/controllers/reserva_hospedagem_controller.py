...
class ReservaController(object):
    ...
    @reserva_controller.route('/reserva/cadastrar', methods=['POST'])
    ...
    @reserva_controller.route('/reserva/consultar/<id_reserva>', methods=['GET'])
    def consultar_reserva_id(id_reserva):
        reserva = Reserva.query.filter_by(id_reserva=id_reserva).first()
        reserva_schema = ReservaSchema()
        return custom_response(reserva_schema.dump(reserva), 200)

    @reserva_controller.route('/reserva/atualizar/<id_reserva>', methods=['PUT'])
    ...
    @reserva_controller.route('/reserva/deletar/<id_reserva>', methods=['DELETE'])
